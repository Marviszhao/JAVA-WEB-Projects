...
public class BoughtStockServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List list = buyStockService.queryBoughtStocks(userID);
		request.setAttribute("boughtGoodsList", list);
		try {
			request.getRequestDispatcher("/admin/boughtStocksList.jsp").forward(request, response);
